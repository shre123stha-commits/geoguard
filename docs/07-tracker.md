...
**Current task:** 1.9 (decision-level fusion + score + tests)
...
- **Done (2026-09-19, Arena Agent):** Phase 0 (except manual 0.3/0.7), 1.1–1.8. pytest **55 passed**. First real detection outlines exist: `docs/samples/candidates_optical.geojson` (5 features, all valid MultiPolygon, EPSG:4326) and `candidates_radar.geojson` (6). Owner should open them at geojson.io over satellite to eyeball against Wayback.
