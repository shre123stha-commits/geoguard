...
**Current task:** 1.7 (radar preprocessing + change mask)
...
- **Done (2026-09-19, Arena Agent):** Phase 0 (except manual 0.3/0.7), 1.1–1.6. pytest **47 passed**. Optical mask on real composites: 3.2 % of AOI, both controls 0 %, West-1 4.7 % in compact blobs. `data/composites/optical_change.npz` saved (mask, centred d_bui/d_ndvi, water).
