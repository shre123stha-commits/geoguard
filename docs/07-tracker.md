...
**Current task:** 1.11 (go/no-go decision)
...
- **Done (2026-09-19, Arena Agent):** Phase 0 (except manual 0.3/0.7), 1.1–1.10. pytest **65 passed**. Metrics on 9 labelled sites: high precision 3/3, overall 6 tp / 0 fp / 2 unsure, recall 6/7. Known limits recorded: single houses < 400 m² (≈ 4 px) are not resolved; `low` fires once in the built-up control; labels are few and 9 months off the baseline window.
